...
@api_router.get("/fleet/vehicles/{vehicle_id}")
...
# ============ FLEET MANAGEMENT - TEAM ASSIGNMENT ============
...
@api_router.post("/fleet/vehicles/{vehicle_id}/team")
async def assign_team_member(
    ...
    # Check if vehicle is locked (active mission)
    ...
    # Check if user is assigned to another vehicle
...
@api_router.delete("/fleet/vehicles/{vehicle_id}/team/{user_id}")
...
@api_router.put("/fleet/vehicles/{vehicle_id}/team/{user_id}/replace")
...
# ============ FLEET MANAGEMENT - TEAM LOCKING ============

@api_router.post("/fleet/vehicles/{vehicle_id}/lock")
async def lock_vehicle_team(
    ...
    # Validate required roles are filled
...
@api_router.post("/fleet/vehicles/{vehicle_id}/unlock")
...
# ============ FLEET MANAGEMENT - REMOTE DOCTOR ============

@api_router.post("/fleet/vehicles/{vehicle_id}/remote-doctor")
...
@api_router.delete("/fleet/vehicles/{vehicle_id}/remote-doctor/{doctor_id}")
...
# ============ FLEET MANAGEMENT - VALIDATION & QUERIES ============

@api_router.get("/fleet/vehicles/{vehicle_id}/validate-team")
...
@api_router.get("/fleet/vehicles/{vehicle_id}/audit")
...
@api_router.get("/fleet/available-staff")
async def get_available_staff(
    ...
    if role:
        ...
        role_mapping = {
            ...
            "paramedic": UserRole.NURSE,  # Paramedics often use nurse role
